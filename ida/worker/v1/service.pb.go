...
// ImportFlutterRequest provides the Flutter/Dart metadata path
type ImportFlutterRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MetaJsonPath  string                 `protobuf:"bytes,1,opt,name=meta_json_path,json=metaJsonPath,proto3" json:"meta_json_path,omitempty"` // Path to the flutter metadata JSON file
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_ida_worker_v1_service_proto_rawDesc = "" +
	...
	"\fStatusStream\x12\".ida.worker.v1.StatusStreamRequest\x1a\x1b.ida.worker.v1.WorkerStatus0\x01B5Z3github.com/wklwkl115/ida-pilot/ida/worker/v1;workerb\x06proto3"
